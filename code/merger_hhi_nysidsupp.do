********************************************
* Merger together market- and hospital-level datasets to HCUP NY SID SUPP dataset
********************************************
clear
set more off
...
di in red "...merging HCUP NY SID SUPP 2006-2012 data..."
	merge 1:m ahaid year using "`proj_dir'/data_sidclean/sid_work/ny_sid_0612_supp.dta"
