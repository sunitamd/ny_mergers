...
```{r, include=TRUE, cols.print=8, rows.print=26}
mdc_kmeans_data
```
...
mdc_gplots <- lapply(2:6, function(k, .kmeans=mdc_kmeans, .df=df) {
    ...
    ggplot(temp, aes(Medicaid, Private, color=cluster)) +
        ...
        coord_cartesian(xlim=c(-6e4,12e4), ylim=c(-1e4,10e4)) +
