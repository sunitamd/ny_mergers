...
```{r histograms, include=TRUE, results='asis', message=FALSE}
for (util in utils) {
	...
	ggplot(temp, aes(drg, fill=payer)) +
		...
		scale_x_continuous(limits=c(0,1000), breaks=seq(100,900,100)) +
	...
	print(
	ggplot(temp, aes(drg)) +
		geom_histogram(bins=200, color='grey40', fill='grey50') +
